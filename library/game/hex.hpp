...
inline bool operator==(const AxialVec& a, const AxialVec& b){
...
inline CubeVec operator+(const CubeVec& a, const CubeVec& b){
	return {a.x + b.x, a.y + b.y, a.z + b.z};
}
inline CubeVec operator-(const CubeVec& a, const CubeVec& b){
	return {a.x - b.x, a.y - b.y, a.z - b.z};
...
inline CubeVec& operator+=(CubeVec& a, const CubeVec& b){
	return (a = a + b);
}
inline CubeVec& operator-=(CubeVec& a, const CubeVec& b){
	return (a = a - b);
...
inline AxialVec operator+(const AxialVec& a, const AxialVec& b){
	return {a.q + b.q, a.r + b.r};
}
inline AxialVec operator-(const AxialVec& a, const AxialVec& b){
	return {a.q - b.q, a.r - b.r};
...
inline AxialVec& operator+=(AxialVec& a, const AxialVec& b){
	return (a = a + b);
}
inline AxialVec& operator-=(AxialVec& a, const AxialVec& b){
	return (a = a - b);
...
extern AxialVec cube_to_axial(const CubeVec& a);
extern CubeVec axial_to_cube(const AxialVec& a);

extern int cube_distance(const CubeVec& a, const CubeVec& b);
extern int axial_distance(const AxialVec& a, const AxialVec& b);

extern AxialVec axial_rotate(const AxialVec& p, const AxialVec& c);

extern std::array<AxialVec, 6> axial_neighbours(const AxialVec& a);
