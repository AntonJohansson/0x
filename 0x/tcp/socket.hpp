...
extern void send(Socket& s, 		unsigned char* data, size_t size);
extern void send_all(Socket& s, unsigned char* data, size_t size);
...
inline void valid(Socket& s){return s != INVALID;}
